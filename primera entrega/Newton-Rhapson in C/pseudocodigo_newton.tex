...
\caption{Método de Newton-Raphson en $\mathbb{R}$ }
\KwIn{aproximación inicial $p_0$, tolerancia TOL, máximo número de iteraciones $n_{max}$}\
...
\BlankLine
\While{$i \le n_max $}{
    \If{$\|p-p_0\|<TOL$}{\tcp{Procedimiento exitoso}\Return{p}} 
    $i = i + 1$
    \BlankLine
    $p = p_0$
}
